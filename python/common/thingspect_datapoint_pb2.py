...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Z%github.com/thingspect/proto/go/common'
  _globals['_DATAPOINT'].oneofs_by_name['val_oneof']._loaded_options = None
  _globals['_DATAPOINT'].oneofs_by_name['val_oneof']._serialized_options = b'\370B\001'
  _globals['_DATAPOINT'].fields_by_name['uniq_id']._loaded_options = None
  _globals['_DATAPOINT'].fields_by_name['uniq_id']._serialized_options = b'\340A\002\372B\006r\004\020\005\030('
  _globals['_DATAPOINT'].fields_by_name['attr']._loaded_options = None
  _globals['_DATAPOINT'].fields_by_name['attr']._serialized_options = b'\340A\002\372B\004r\002\030('
  _globals['_DATAPOINT'].fields_by_name['token']._loaded_options = None
  _globals['_DATAPOINT'].fields_by_name['token']._serialized_options = b'\340A\003'
  _globals['_DATAPOINT'].fields_by_name['trace_id']._loaded_options = None
  _globals['_DATAPOINT'].fields_by_name['trace_id']._serialized_options = b'\340A\003'
  _globals['_DATAPOINT']._serialized_start=148
  _globals['_DATAPOINT']._serialized_end=424
