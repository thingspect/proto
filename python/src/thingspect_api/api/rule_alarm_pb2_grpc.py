...
class RuleAlarmServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateAlarm = channel.unary_unary(
                ...
                request_serializer=api_dot_rule__alarm__pb2.CreateAlarmRequest.SerializeToString,
                response_deserializer=api_dot_rule__alarm__pb2.Alarm.FromString,
                )
        ...
        self.GetAlarm = channel.unary_unary(
                ...
                request_serializer=api_dot_rule__alarm__pb2.GetAlarmRequest.SerializeToString,
                response_deserializer=api_dot_rule__alarm__pb2.Alarm.FromString,
                )
        ...
        self.UpdateAlarm = channel.unary_unary(
                ...
                request_serializer=api_dot_rule__alarm__pb2.UpdateAlarmRequest.SerializeToString,
                response_deserializer=api_dot_rule__alarm__pb2.Alarm.FromString,
                )
        self.DeleteRule = channel.unary_unary(
                '/thingspect.api.RuleAlarmService/DeleteRule',
                request_serializer=api_dot_rule__alarm__pb2.DeleteRuleRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        self.DeleteAlarm = channel.unary_unary(
                '/thingspect.api.RuleAlarmService/DeleteAlarm',
                request_serializer=api_dot_rule__alarm__pb2.DeleteAlarmRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        self.ListRules = channel.unary_unary(
                '/thingspect.api.RuleAlarmService/ListRules',
                request_serializer=api_dot_rule__alarm__pb2.ListRulesRequest.SerializeToString,
                response_deserializer=api_dot_rule__alarm__pb2.ListRulesResponse.FromString,
                )
        self.ListAlarms = channel.unary_unary(
                '/thingspect.api.RuleAlarmService/ListAlarms',
                request_serializer=api_dot_rule__alarm__pb2.ListAlarmsRequest.SerializeToString,
                response_deserializer=api_dot_rule__alarm__pb2.ListAlarmsResponse.FromString,
                )
        self.TestRule = channel.unary_unary(
                '/thingspect.api.RuleAlarmService/TestRule',
                request_serializer=api_dot_rule__alarm__pb2.TestRuleRequest.SerializeToString,
                response_deserializer=api_dot_rule__alarm__pb2.TestRuleResponse.FromString,
                )
        self.TestAlarm = channel.unary_unary(
                '/thingspect.api.RuleAlarmService/TestAlarm',
                request_serializer=api_dot_rule__alarm__pb2.TestAlarmRequest.SerializeToString,
                response_deserializer=api_dot_rule__alarm__pb2.TestAlarmResponse.FromString,
                )
...
def add_RuleAlarmServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CreateAlarm': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=api_dot_rule__alarm__pb2.CreateAlarmRequest.FromString,
                    response_serializer=api_dot_rule__alarm__pb2.Alarm.SerializeToString,
            ),
            ...
            'GetAlarm': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAlarm,
                    request_deserializer=api_dot_rule__alarm__pb2.GetAlarmRequest.FromString,
                    response_serializer=api_dot_rule__alarm__pb2.Alarm.SerializeToString,
            ),
            ...
            'UpdateAlarm': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=api_dot_rule__alarm__pb2.UpdateAlarmRequest.FromString,
                    response_serializer=api_dot_rule__alarm__pb2.Alarm.SerializeToString,
            ),
            'DeleteRule': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteRule,
                    request_deserializer=api_dot_rule__alarm__pb2.DeleteRuleRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'DeleteAlarm': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteAlarm,
                    request_deserializer=api_dot_rule__alarm__pb2.DeleteAlarmRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'ListRules': grpc.unary_unary_rpc_method_handler(
                    servicer.ListRules,
                    request_deserializer=api_dot_rule__alarm__pb2.ListRulesRequest.FromString,
                    response_serializer=api_dot_rule__alarm__pb2.ListRulesResponse.SerializeToString,
            ),
            'ListAlarms': grpc.unary_unary_rpc_method_handler(
                    servicer.ListAlarms,
                    request_deserializer=api_dot_rule__alarm__pb2.ListAlarmsRequest.FromString,
                    response_serializer=api_dot_rule__alarm__pb2.ListAlarmsResponse.SerializeToString,
            ),
            'TestRule': grpc.unary_unary_rpc_method_handler(
                    servicer.TestRule,
                    request_deserializer=api_dot_rule__alarm__pb2.TestRuleRequest.FromString,
                    response_serializer=api_dot_rule__alarm__pb2.TestRuleResponse.SerializeToString,
            ),
            'TestAlarm': grpc.unary_unary_rpc_method_handler(
                    servicer.TestAlarm,
                    request_deserializer=api_dot_rule__alarm__pb2.TestAlarmRequest.FromString,
                    response_serializer=api_dot_rule__alarm__pb2.TestAlarmResponse.SerializeToString,
            ),
    }
...
class RuleAlarmService(object):
    ...
    def CreateAlarm(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/thingspect.api.RuleAlarmService/CreateAlarm',
            api_dot_rule__alarm__pb2.CreateAlarmRequest.SerializeToString,
            api_dot_rule__alarm__pb2.Alarm.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetAlarm(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/thingspect.api.RuleAlarmService/GetAlarm',
            api_dot_rule__alarm__pb2.GetAlarmRequest.SerializeToString,
            api_dot_rule__alarm__pb2.Alarm.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UpdateAlarm(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/thingspect.api.RuleAlarmService/UpdateAlarm',
            api_dot_rule__alarm__pb2.UpdateAlarmRequest.SerializeToString,
            api_dot_rule__alarm__pb2.Alarm.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteRule(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/thingspect.api.RuleAlarmService/DeleteRule',
            api_dot_rule__alarm__pb2.DeleteRuleRequest.SerializeToString,
    ...
    def DeleteAlarm(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/thingspect.api.RuleAlarmService/DeleteAlarm',
            api_dot_rule__alarm__pb2.DeleteAlarmRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ListRules(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/thingspect.api.RuleAlarmService/ListRules',
            api_dot_rule__alarm__pb2.ListRulesRequest.SerializeToString,
            api_dot_rule__alarm__pb2.ListRulesResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ListAlarms(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/thingspect.api.RuleAlarmService/ListAlarms',
            api_dot_rule__alarm__pb2.ListAlarmsRequest.SerializeToString,
            api_dot_rule__alarm__pb2.ListAlarmsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def TestRule(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/thingspect.api.RuleAlarmService/TestRule',
            api_dot_rule__alarm__pb2.TestRuleRequest.SerializeToString,
            api_dot_rule__alarm__pb2.TestRuleResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def TestAlarm(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/thingspect.api.RuleAlarmService/TestAlarm',
            api_dot_rule__alarm__pb2.TestAlarmRequest.SerializeToString,
            api_dot_rule__alarm__pb2.TestAlarmResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
