...
from api import alert_pb2 as api_dot_alert__pb2
...
class AlertServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListAlerts = channel.unary_unary(
                ...
                request_serializer=api_dot_alert__pb2.ListAlertsRequest.SerializeToString,
                response_deserializer=api_dot_alert__pb2.ListAlertsResponse.FromString,
                )
...
def add_AlertServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ListAlerts': grpc.unary_unary_rpc_method_handler(
                    servicer.ListAlerts,
                    request_deserializer=api_dot_alert__pb2.ListAlertsRequest.FromString,
                    response_serializer=api_dot_alert__pb2.ListAlertsResponse.SerializeToString,
            ),
    }
...
class AlertService(object):
    ...
    def ListAlerts(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/thingspect.api.AlertService/ListAlerts',
            api_dot_alert__pb2.ListAlertsRequest.SerializeToString,
            api_dot_alert__pb2.ListAlertsResponse.FromString,
