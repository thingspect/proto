...
class Payload extends $pb.GeneratedMessage {
  factory Payload({
    $core.Iterable<$0.DataPoint>? points,
    $core.String? token,
  }) {
    final $result = create();
    if (points != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Payload', package: const $pb.PackageName(_omitMessageNames ? '' : 'thingspect.mqtt'), createEmptyInstance: create)
    ..pc<$0.DataPoint>(1, _omitFieldNames ? '' : 'points', $pb.PbFieldType.PM, subBuilder: $0.DataPoint.create)
