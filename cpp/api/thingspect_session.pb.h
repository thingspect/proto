...
/* @@protoc_insertion_point(class_definition:thingspect.api.ListKeysResponse) */ {
 ...
 public:
  ...
  ::google::protobuf::RepeatedPtrField<::thingspect::api::Key>* mutable_keys();
...
inline ::thingspect::api::Key* CreateKeyRequest::mutable_key() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline ::thingspect::api::Key* CreateKeyResponse::mutable_key() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000001u;
  ::thingspect::api::Key* _msg = _internal_mutable_key();
...
inline ::google::protobuf::RepeatedPtrField<::thingspect::api::Key>* ListKeysResponse::mutable_keys()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::thingspect::api::Key* ListKeysResponse::add_keys() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
