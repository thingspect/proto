 ...
 *
 * Generated from protobuf message <code>thingspect.api.ListKeysResponse</code>
 */
class ListKeysResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Thingspect\Api\Key::class);
        $this->keys = $arr;
